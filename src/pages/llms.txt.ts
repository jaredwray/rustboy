...
export const GET: APIRoute = async ({ site }) => {
  ...
  const lines = [
    ...
    `- [Storyboard](${absolute("/storyboard/")}): production board for plates 1–25 (kf## keyframes), with stills and clips as they land. Finished is LOCK; parked is HOLD; waiting is PASS.`,
